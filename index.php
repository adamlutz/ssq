            ...
            $('#apm_media_wrapper').apmplayer_ui({
                ...
                onMetadata : function (playable) {
                    ...
                    if (playable.title !== ''
                        ...
                        snippet += "<strong><i>"+playable.title+"</i></strong>";
    ...
    <div class="container">
        ...
        <div id="bio">
          <table class="section">
            ...
            <tr>
                <td></td>
                <td><img src="resources/imgs/2014-band-photo.jpg" height='341' width='512' class="floatright">Sans Souci is known for its unique blend of bluegrass, folk rock and innovation.  The instruments are traditional, the voices authentic, and the arrangements are unique and refreshing.
